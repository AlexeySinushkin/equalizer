...
pub(crate) const SHUTDOWN_SPEED : usize = 105 * 1024 / 1000;//Убрать ссылки, инициализировать объекты по-требованию
...
pub(crate) const ANALYZE_DURATION: Duration = Duration::from_secs(8);
//меняем скорость не чаще этого периода
pub(crate) const INCREASE_SPEED_PERIOD: Duration = Duration::from_secs(1);
